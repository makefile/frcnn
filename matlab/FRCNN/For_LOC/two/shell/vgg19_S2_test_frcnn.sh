...
time GLOG_log_dir=matlab/FRCNN/For_LOC/two/vgg19/log $BUILD --gpu $gpu \
    ...
    --out_file matlab/FRCNN/For_LOC/two/vgg19/out/TWO_5297_9958_test_list_vgg19_${pid}.frcnn \
    --max_per_image 100
