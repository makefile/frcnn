/**
upsample faster than the current deconvolution way.
The difference is this upsample layer implements Nearest Neighborhood, but deconvolution layer implements Bi-Linear. However, in experiment in FPN (https://arxiv.org/abs/1612.03144), it does not affect the accuracy no matter what algorithm you choose.

this pull request is from: https://github.com/BVLC/caffe/pull/6384
...
EXPORT_LAYER_MODULE_CLASS(Upsample);
