...
# this script works for darknet yolov3
import sys
sys.path.append('/home/gpu02/fyk/frcnn/python')
import caffe
import numpy as np
...
def cfg2prototxt(cfgfile):
    ...
    for block in blocks:
	    ...
	    upsample_layer['type'] = 'Module'
	    upsample_param = OrderedDict()
	    upsample_param['module'] = 'modules'
	    upsample_param['type'] = 'Upsample'
	    upsample_param['param_str'] = "{'scale': %s}"%block['stride']
	    upsample_layer['module_param'] = upsample_param
