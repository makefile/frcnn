...
time GLOG_log_dir=matlab/FRCNN/For_LOC/two/vgg19/log $CAFFE train   \
    --gpu $gpu \
    --solver matlab/FRCNN/For_LOC/two/vgg19/solver.proto \
    --weights matlab/FRCNN/For_LOC/two/vgg19/VGG19.v2.caffemodel
