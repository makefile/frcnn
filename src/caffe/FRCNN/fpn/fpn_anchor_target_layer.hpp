...
// 2016/03/30
// ------------------------------------------------------------------
#ifndef CAFFE_FPN_ANCHOR_TARGET_LAYER_HPP_
#define CAFFE_FPN_ANCHOR_TARGET_LAYER_HPP_
...
class FPNAnchorTargetLayer : public Layer<Dtype> {
 public:
  explicit FPNAnchorTargetLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
...
#endif  // CAFFE_FPN_ANCHOR_TARGET_LAYER_HPP_
