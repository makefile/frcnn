...
template <typename Dtype>
Point5f<Dtype> bbox_transform(const Point5f<Dtype>& ex_rois,const Point5f<Dtype>& gt_rois);

template <typename Dtype>
std::vector<Point5f<Dtype> > bbox_transform(const std::vector<Point5f<Dtype> >& ex_rois,
                                 const std::vector<Point5f<Dtype> >& gt_rois);
