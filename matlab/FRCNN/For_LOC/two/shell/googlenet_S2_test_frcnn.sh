...
time GLOG_log_dir=matlab/FRCNN/For_LOC/two/googlenet_v1/log $BUILD --gpu $gpu \
    ...
    --out_file matlab/FRCNN/For_LOC/two/googlenet_v1/out/TWO_5297_9958_test_list_googlenet_v1_${pid}.frcnn \
    --max_per_image 100
