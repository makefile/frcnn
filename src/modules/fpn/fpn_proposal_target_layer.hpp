...
// 2016/03/31
// ------------------------------------------------------------------
#ifndef CAFFE_FPN_PROPOSAL_TARGET_LAYER_HPP_
#define CAFFE_FPN_PROPOSAL_TARGET_LAYER_HPP_
...
class FPNProposalTargetLayer : public Layer<Dtype> {
 public:
  explicit FPNProposalTargetLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "FPNProposalTarget"; }
...
#endif  // CAFFE_FPN_PROPOSAL_TARGET_LAYER_HPP_
