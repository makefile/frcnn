...
float FrcnnParam::bbox_inside_weights[5];
float FrcnnParam::bbox_normalize_means[5];
float FrcnnParam::bbox_normalize_stds[5];
...
float FrcnnParam::rpn_bbox_inside_weights[5];
